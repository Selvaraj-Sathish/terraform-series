...
Specify the CIDR block as 192.168.0.0/24.
Click Create subnet.
Private Subnet
...
Stay tuned for more exercises and tutorials in our series! Keep up the great work. 💪
...
Visit the detailed guide on how to set up this same infrastructure using Terraform on my GitHub repository: Terraform VPC Guide. 

Switch from manual setup to automation today! 🚀
